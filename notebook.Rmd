...
summary(glmStat)
```
We can see that there is some correlation happening in the model, as evidenced by the "NA" in some of the predictors. Let's see which predictors they correlate to.
...
playerResults <- data.frame(
   ...
   PValue = c(
       cmRFPlayers$overall["McnemarPValue"], cmPosition$overall["McnemarPValue"], cmPlayerOverall$overall["McnemarPValue"], cmOverallDate$overall["McnemarPValue"])
)

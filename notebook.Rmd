...
teamResults <- data.frame(
    ...
    Precision = c(cmRF$overall["Precision"], cmMid$overall["Precision"], cmAtt$overall["Precision"], cmDef$overall["Precision"],
        cmCoach$overall["Precision"]),
    Recall = c(cmRF$overall["Recall"], cmMid$overall["Recall"], cmAtt$overall["Recall"], cmDef$overall["Recall"],
        cmCoach$overall["Recall"]),
    F-1 Score = c(cmRF$overall["F1"], cmMid$overall["F1"], cmAtt$overall["F1"], cmDef$overall["F1"],
        cmCoach$overall["F1"])
)
...
playerResults <- data.frame(
   ...
   Precision = c(cmRFPlayers$overall["Precision"], cmPosition$overall["Precision"], cmPlayerOverall$overall["Precision"], cmOverallDate$overall["Precision"]),
   Recall = c(cmRFPlayers$overall["Recall"], cmPosition$overall["Recall"], cmPlayerOverall$overall["Recall"], cmOverallDate$overall["Recall"]),
   F-1 Score = c(cmRFPlayers$overall["F1"], cmPosition$overall["F1"], cmPlayerOverall$overall["F1"], cmOverallDate$overall["F1"])
)
